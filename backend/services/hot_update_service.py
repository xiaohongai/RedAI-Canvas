...
class HotUpdateService:
    ...
    def __init__(
        ...
        *,
        ...
        local_version,
        is_dev_build,
        update_manifest_url="https://github.com/xiaohongai/RedAI-Canvas/releases/latest/download/latest.json",
        update_release_url="https://github.com/xiaohongai/RedAI-Canvas/releases/latest",
    ...
    def fetch_update_manifest(self):
        headers = {
            "User-Agent": "RedAI-Canvas-AutoUpdate/2.0",
